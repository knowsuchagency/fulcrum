  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        "after:bg-foreground after:absolute after:origin-center after:transition-transform after:duration-200 group-data-[orientation=horizontal]/tabs:after:inset-x-0 group-data-[orientation=horizontal]/tabs:after:bottom-[-5px] group-data-[orientation=horizontal]/tabs:after:h-0.5 group-data-[orientation=horizontal]/tabs:after:scale-x-0 group-data-[orientation=vertical]/tabs:after:inset-y-0 group-data-[orientation=vertical]/tabs:after:-right-1 group-data-[orientation=vertical]/tabs:after:w-0.5 group-data-[orientation=vertical]/tabs:after:scale-y-0 group-data-[variant=line]/tabs-list:data-active:group-data-[orientation=horizontal]/tabs:after:scale-x-100 group-data-[variant=line]/tabs-list:data-active:group-data-[orientation=vertical]/tabs:after:scale-y-100",
        className
      )}
      {...props}
    />
...
function TabsContent({ className, ...props }: TabsPrimitive.Panel.Props) {
  return (
    <TabsPrimitive.Panel
      ...
      className={cn("text-xs/relaxed flex-1 min-h-0 outline-none", className)}
      {...props}
    />
  )
}
